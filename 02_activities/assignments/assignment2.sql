...
-- PARTICIPANT NAME: Jingkenh (Ken) Loh
...
CROSS JOIN 
    CustomerCount cc
GROUP BY 
    vp.vendor_name, vp.product_name, vp.original_price;
...
VALUES (24, 'Eggs - Free Run', '1 Dozen', 6, 'unit', CURRENT_TIMESTAMP);
...
WHERE product_name = 'Eggs - Free Run'
